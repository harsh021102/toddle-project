...
const CreatePostCard = ({toggleCreateBoardCard,showcard}) => {
    const handleClick = () => {
       ...
       <div className="absolute w-[458px] h-[530px] bg-white border-[1px] border-[#EBEBEB] shadow-md rounded-[8px]">
        <div className="w-[407px] h-[220.05px] mx-[26px] mt-[21px]">
            ...
            <div className='flex items-center w-[407px] h-[48px] mt-[8px] border-[1px] border-[#DBDBDB] rounded-[4px] px-[10.11px]'>
                <input type="text" className='font-avenir text-[16px] leading-[22px] text-[#222222]  outline-none w-10/12' placeholder="Type here"/>
            </div>
            <UploadImage/>
            ...
            <div className="flex items-center p-[16px] gap-[16px] w-[407px] h-[76px] border-[1px] border-[#000000] rounded-[6px]">
                <input type="text" placeholder='Type here' className='flex w-[375px] h-[44px] items-start font-avenir font-[500] text-[16px] leading-[24px] text-[#B0B0B0] outline-none overflow-x-auto'/>
            </div>
